...
function getOptions (req) {
	var ops = {
		...
		customActionType: this.options.customActionType, // Dropdown or Link
		customCreateButton: this.options.customCreateButton, // Dropdown on List's create button
		customButtonOptions: this.options.customButtonOptions, // Custom Create Button's Dropdown options
	};
